...
@interface FlutterBarcodeScannerPlugin ()
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    FlutterMethodChannel* channel = [FlutterMethodChannel
                                     methodChannelWithName:@"com.github.jortdebokx/flutter_barcode_scanner"
                                     binaryMessenger:[registrar messenger]];
    FlutterBarcodeScannerPlugin* instance = [[FlutterBarcodeScannerPlugin alloc] initWithRegistry:[registrar textures] channel:channel];
...
- (void)startWithCallback:(void (^)(int height, int width, int orientation, int64_t textureId))completedCallback orFailure:(void (^)(NSError *))failureCallback {
    ...
    _reader.onCodeAvailable = ^(NSString *value, NSString *type) {
        [channel invokeMethod:@"barcodeRead" arguments: @[value, type]];
    };
